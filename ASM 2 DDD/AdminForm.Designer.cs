namespace ASM_2_DDD
{
    partial class AdminForm
    {
		...
		private void InitializeComponent()
		{
			...
			comboBoxClassID.Location = new Point(530, 149);
			comboBoxClassID.Name = "comboBoxClassID";
			comboBoxClassID.Size = new Size(121, 23);
			comboBoxClassID.TabIndex = 15;
			comboBoxClassID.SelectedIndexChanged += comboBox1_SelectedIndexChanged;
			// 
			// AdminForm
			// 
